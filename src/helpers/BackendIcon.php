...
final class BackendIcon
{
    private const ICONS = [
        ...
        'server' => '<rect x="3" y="4" width="18" height="6" rx="2"></rect><rect x="3" y="14" width="18" height="6" rx="2"></rect><path d="M7 7h.01"></path><path d="M7 17h.01"></path><path d="M11 7h6"></path><path d="M11 17h6"></path>',
        ...
        'folder' => '<path d="M3 6a2 2 0 0 1 2-2h5l2 3h7a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>',
        'folder-open' => '<path d="M3 7V6a2 2 0 0 1 2-2h5l2 3h7a2 2 0 0 1 2 2v1"></path><path d="M3 10h18l-2 9H5z"></path>',
    ...
    /**
     * Render a semantic icon name while retaining explicit compatibility with
     * legacy icon-font class strings during package migration.
     *
     * @param string $icon
     * @param array $options
     * @return string
     */
    public static function renderConfigured($icon, array $options = [])
    {
        if (self::supports($icon)) {
            return self::render($icon, $options);
        }
